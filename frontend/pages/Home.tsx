...
export default function Home() {
  ...
  const getCardGradient = (issuer: string) => {
    ...
    if (name.includes('citi')) return 'from-fuchsia-500 to-blue-700 text-white shadow-[0_8px_30px_rgba(6,182,212,0.3)]';
    if (name.includes('capital one')) return 'from-fuchsia-500 to-fuchsia-600 text-white shadow-[0_8px_30px_rgba(30,41,59,0.4)]';
    return 'from-fuchsia-500 to-fuchsia-600 text-white shadow-[0_8px_30px_rgba(230,75,212,0.3)]';
  };
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 space-y-12">
      ...
      <div className="text-center space-y-4 max-w-3xl mx-auto">
        <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-fuchsia-500/10 to-fuchsia-500/10 border border-fuchsia-500/30 text-fuchsia-400 px-4 py-1.5 rounded-full text-xs font-semibold uppercase tracking-wider animate-pulse">
          <Sparkle className="h-3 w-3 text-fuchsia-400" />
          <span>Max out cashback, not credit limits</span>
        </div>
        
        <h1 className="text-4xl md:text-5xl font-black text-fuchsia-400 tracking-tight leading-none">
          {user ? `Welcome back, ${user.firstName || 'there'}!` : 'Meet the Sleekest'}
          <span className="block bg-gradient-to-r from-fuchsia-500 via-fuchsia-500 to-fuchsia-600 bg-clip-text text-transparent font-extrabold mt-1">
            {user ? 'Maximize rewards today' : 'Credit Card Optimizer'}
          </span>
        </h1>
        
        <p className="text-base md:text-lg text-fuchsia-400 font-medium max-w-xl mx-auto leading-relaxed">
          {user 
              ...
              {sortedExpiringOffers.slice(0, 3).map((offer) => {
                ...
                return (
                  <Link 
                    ...
                    className="group bg-white/5 hover:bg-fuchsia-500/12 border border-fuchsia-500/25 hover:border-red-200 transition-all duration-300 rounded-2xl p-4 flex flex-col justify-between space-y-3 relative shadow-sm"
                  >
                    <div className="flex justify-between items-start gap-2">
                      <div>
                        <span className="text-[10px] font-extrabold text-fuchsia-400 uppercase tracking-wider">{offer.cardName}</span>
                        <h4 className="font-extrabold text-fuchsia-400 text-sm mt-0.5 group-hover:text-fuchsia-400 transition-colors">{offer.merchantName}</h4>
                      </div>
                    ...
                    <div className="space-y-2">
                      <p className="text-[11px] font-medium text-fuchsia-400 line-clamp-2 leading-relaxed">{offer.offerDescription}</p>
                      
                      <div className="flex items-center text-[10px] font-bold text-fuchsia-400 group-hover:translate-x-1 transition-transform">
                        <span>Swipe Now</span>
      ...
      <Card className="border-0 bg-fuchsia-600 text-white overflow-hidden shadow-2xl relative">
        {/* Glowing background meshes */}
        <div className="absolute top-0 right-0 w-80 h-80 bg-fuchsia-500/10 rounded-full blur-3xl -z-0 pointer-events-none" />
        ...
        <CardContent className="p-6 md:p-8 relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="space-y-3 text-center md:text-left flex-1">
            <div className="inline-flex items-center space-x-2 bg-white/10 px-3 py-1 rounded-full text-[10px] uppercase font-bold tracking-widest text-fuchsia-400">
              <Mic className="h-3.5 w-3.5" />
              <span>Voice Activated</span>
            </div>
            <h3 className="text-2xl font-bold tracking-tight">"Where should I buy groceries?"</h3>
            <p className="text-fuchsia-400 text-sm max-w-md font-medium">
          ...
          <div className="flex flex-col items-center justify-center p-4 bg-white/5 rounded-2xl border border-white/10 w-full md:w-auto min-w-[200px] text-center">
            ...
            <div className="relative w-16 h-16 flex items-center justify-center mb-3">
              <span className="absolute inset-0 rounded-full bg-gradient-to-r from-fuchsia-500 via-pink-400 to-purple-500 blur-md opacity-75 animate-pulse scale-110"></span>
              <span className="absolute inset-2 rounded-full bg-fuchsia-600 flex items-center justify-center">
                <Mic className="h-6 w-6 text-fuchsia-400 animate-bounce" />
              </span>
            </div>
            <span className="text-[11px] font-semibold text-fuchsia-400 uppercase tracking-widest animate-pulse">Siri Bot Ready</span>
          </div>
        </CardContent>
      </Card>
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-extrabold tracking-tight text-fuchsia-400">
              {user ? 'My Cards Portfolio' : 'Featured Cashback Renders'}
            </h2>
            <p className="text-fuchsia-400 text-xs font-semibold uppercase tracking-wider mt-0.5">
              {user ? 'Tap optimized to swipe best card' : 'Sleek physical card aesthetics'}
            </p>
          </div>
          <Link to="/cards" className="text-fuchsia-400 hover:text-fuchsia-400 text-sm font-semibold flex items-center space-x-1 hover:underline">
        ...
        {user && portfolioCards.length > 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            ...
            {/* Citi Double Cash */}
            <div className="relative aspect-[1.586/1] rounded-2xl p-5 flex flex-col justify-between overflow-hidden bg-gradient-to-br from-fuchsia-500 to-blue-700 text-white shadow-[0_8px_30px_rgba(6,182,212,0.3)] transition-all duration-300 hover:scale-[1.03] hover:rotate-1">
              <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-white/5 to-white/10 pointer-events-none" />
              <div className="flex justify-between items-start">
                <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Link to="/recommendations">
          <Card className="group hover:shadow-[0_20px_40px_-15px_rgba(13,148,136,0.15)] transition-all duration-500 border-0 bg-gradient-to-br from-fuchsia-500 to-fuchsia-600 hover:from-fuchsia-500 hover:to-fuchsia-600 cursor-pointer overflow-hidden relative">
            <CardContent className="p-8">
              <div className="flex items-center space-x-6">
                <div className="p-4 bg-fuchsia-500 rounded-2xl text-white group-hover:scale-110 transition-transform duration-500 shadow-md">
                  <Target className="h-7 w-7" />
                </div>
                <div className="space-y-1">
                  <h3 className="font-bold text-lg text-fuchsia-400">Optimize Purchase</h3>
                  <p className="text-xs text-fuchsia-400 font-semibold uppercase tracking-wider">Search categories instantly</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <Link to="/cards">
          <Card className="group hover:shadow-[0_20px_40px_-15px_rgba(230,75,212,0.15)] transition-all duration-500 border-0 bg-gradient-to-br from-fuchsia-500 to-fuchsia-600 hover:from-fuchsia-500 hover:to-fuchsia-600 cursor-pointer overflow-hidden relative">
            <CardContent className="p-8">
              <div className="flex items-center space-x-6">
                <div className="p-4 bg-fuchsia-500 rounded-2xl text-white group-hover:scale-110 transition-transform duration-500 shadow-md">
                ...
                <div className="space-y-1">
                  <h3 className="font-bold text-lg text-fuchsia-400">Browse Card Database</h3>
                  <p className="text-xs text-fuchsia-400 font-semibold uppercase tracking-wider">50+ reward cards registered</p>
                </div>
              </div>
            </CardContent>
          </Card>
      ...
      <Card className="border-0 bg-gradient-to-r from-fuchsia-500 via-fuchsia-500 to-fuchsia-600 text-white shadow-2xl relative overflow-hidden group">
        ...
        <CardContent className="p-6 md:p-8">
          <div className="flex items-start space-x-5">
            ...
            <div className="flex-1 space-y-4">
              ...
              <Link to="/recommendations">
                <Button size="sm" className="bg-white/5 text-fuchsia-400 hover:bg-fuchsia-500/12 font-bold px-5 py-2.5 rounded-xl text-xs uppercase tracking-wider shadow-md">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
        <Card className="border-0 bg-white/60 backdrop-blur-md shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-2xl">
          <CardContent className="p-6 text-center space-y-3">
            <div className="w-12 h-12 bg-fuchsia-500/12 rounded-xl flex items-center justify-center mx-auto text-fuchsia-400">
              <Shield className="h-6 w-6" />
            </div>
            <h3 className="font-bold text-fuchsia-400 text-sm">Secure & Private</h3>
            <p className="text-xs text-fuchsia-400 leading-relaxed">Your wallet portfolio is strictly confidential, encrypted locally, and never shared.</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-0 bg-white/60 backdrop-blur-md shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-2xl">
          <CardContent className="p-6 text-center space-y-3">
            ...
            <h3 className="font-bold text-fuchsia-400 text-sm">Siri Voice Intelligence</h3>
            <p className="text-xs text-fuchsia-400 leading-relaxed">Speak directly to optimize dining, travel, or fuel in less than 2 seconds.</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-0 bg-white/60 backdrop-blur-md shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-2xl">
          <CardContent className="p-6 text-center space-y-3">
            ...
            <h3 className="font-bold text-fuchsia-400 text-sm">100% Free Service</h3>
            <p className="text-xs text-fuchsia-400 leading-relaxed">SwipeRight is entirely free. Our goal is helping you gain every reward point possible.</p>
          </CardContent>
        </Card>
      </div>
    </div>
